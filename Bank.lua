...
send(msg.chat_id,msg.id,"⇜ هذه رشوة بطل زرف "..jjjo.." ريال 💵","md",true)
...
send(msg.chat_id,0, "⇜ "..news.." في حرامي زرفك "..hrame.." ريال 💵\n⇜ رد عليه بكلمة ( شرطه )\n⇜ معك 30 ثانية\n✧","md",true)
else
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(TheMero.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 1000000000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 200000000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 30000000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 1000000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 300000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 120000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 80000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 30000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 3000 ريال 💵","md",true)
end
Redis:del(TheMero.."ratbtrans"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تهجم فلوسك اقل من 100000 ريال 💵","md",true)
end
if tonumber(ballanceed) < 100000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تهجم عليه فلوسه اقل من 100000 ريال 💵","md",true)
end
if tonumber(coniss) < 9999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 10000 ريال 💵\n✧","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح به هو 10000 ريال \n✧","md",true)
end
ballancee = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
...
ballanceed = Redis:get(TheMero.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) > 1000000001 then
return send(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح هو مليار ريال 💵\n✧","md",true)
end
if tonumber(coniss) < 999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 1000 ريال 💵\n✧","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح به هو 10000 ريال \n✧","md",true)
end
if tonumber(coniss) < 999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح به هو 1000 ريال \n✧","md",true)
end
if Redis:ttl(TheMero.."tabrotime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(TheMero.."tabrotime" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ يمديك تتبرع بعد "..time.." ","md",true)
...
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id, "⇜ تبرعاتك : `"..convert_mony.."` ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
